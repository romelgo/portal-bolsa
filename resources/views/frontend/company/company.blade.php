...
<div class="unit-5 overlay" style="background-image: url({{ asset('external/images/hero_2.jpg') }})">
    <div class="container text-center">
      ...
      <p class="mb-0 unit-6"><a href="/">Home</a> <span class="sep"> > <a href="{{ route('company') }}">Empresas</a> </span> <span><span class="sep m-0"> ></span>lista</span></p>
    </div>
</div>
                ...
                <a class="d-block" href="{{ route('company.index', [$company->id,$company->slug]) }}">
                    <div class="card company-card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('company.index', [$company->id,$company->slug]) }}" class="btn btn-primary">Visitar empresa</a>
                        </div>
                    </div>
                </a>
            </div>
