...
Route::get('/jobs/mispostulaciones',[ApplicationController::class, 'myApplications'])->name('jobs.applications');
...
//Route::get('/jobs/applications', [JobController::class, 'myApplications'])->name('jobs.applications');
