...
<div class="unit-5 overlay" style="background-image: url(<?php echo e(asset('uploads/banner')); ?>/<?php echo e($company->banner); ?>);">
    <div class="container text-center">
      ...
      font-size: 2.5rem;">Empresa:<strong>&nbsp;<?php echo e($company->cname); ?></strong></h1>
      <p class="mb-0 unit-6"><a href="/">Home</a> <span class="sep"> > <a href="<?php echo e(route('alljobs')); ?>">Trabajos</a> </span> <span><span class="sep m-0"> ></span> Detalles de la compañía</span></p>
    </div>
</div>
    ...
    <div class="container">
            ...
            <div class="mb-4 mb-md-4 mr-5">
             <div class="job-post-item-header">
                <div class="d-flex align-items-center">
                    ...
                    <h3 class="mx-4 mb-0">Empresa:<strong>&nbsp;<?php echo e($company->cname); ?></strong> </h3>

                </div>
                <p class="mt-3"><strong>Detalles de la compañía:</strong> &nbsp;<?php echo e($company->description); ?></p>
                <p><strong>Slogan:</strong>&nbsp;<?php echo e($company->slogan); ?></p>
                <p><strong>Dirección:</strong>&nbsp;<?php echo e($company->address); ?></p>
                <p><strong>Teléfono:</strong>&nbsp;<?php echo e($company->phone); ?></p>
      ...
      <div class="row">
        ...
        <div class="col-md-12 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
            <div class="p-4 bg-white">
            <h3 class="mb-5 h3"><?php echo e($company->cname); ?> <i style="color: #28a745;" class="icon-hand-o-right"></i> otros trabajos</h3>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\despligue\app-portal\resources\views/frontend/company/index.blade.php ENDPATH**/ ?>