...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"><h3 class="mt-1"><?php echo e(__('Registrese como Usuario')); ?></h3></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="dob" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Fecha de nacimiento')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="gender" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Sexo')); ?></label>

                            <div class="col-md-6">
                                <input id="gender" type="radio" name="gender" value="male"> Masculino
                                <input id="gender" type="radio" name="gender" value="female"> Femenino
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\despligue\portal - copia\resources\views/auth/register.blade.php ENDPATH**/ ?>