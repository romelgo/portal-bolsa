...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"><h3 class="mt-1"><?php echo e(__('Registrar Empresa')); ?></h3></div>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('empl.register')); ?>">
                        ...
                        <div class="row mb-3">
                            <label for="cname" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Nombre Company')); ?></label>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\despligue\portal-v1\resources\views/auth/employer-register.blade.php ENDPATH**/ ?>