<?php $__env->startSection('content'); ?>
    ...
    <i class="material-icons text-white md-5em">favorite</i>
                  ...
                  <div class="ml-5">
                    ...
                    <p> Total de trabajos Guardados</p>
                  </div>
                </div>
              </div>
            </div>
         ...
         <div class="row mt-3">
          ...
          <div class="col-md-4">
            <div class="card">
                <div class="card-header">Candidatos recientes</div>
        ...
        <div class="col-md-4">
          <div class="card">
              <div class="card-header">Empleadores recientes</div>
...
<?php echo $__env->make('../admin/layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\despligue\portal-v1\resources\views/admin/index.blade.php ENDPATH**/ ?>